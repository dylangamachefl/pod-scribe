...
# Add project paths
project_root = Path(r"c:\Users\Dylan\Projects\ai-portfolio\podcast-transcriber")
sys.path.insert(0, str(project_root / "shared"))
sys.path.insert(0, str(project_root / "transcription-service" / "src"))
...
def test_dashboard_aggregation():
    ...
    print("Testing dashboard aggregation fixes...")
    ...
    # Verify GPU/Stats fallback (even if transcription:status was deleted, 
    # we manually set it in write_status now, but let's check fallback logic too)
